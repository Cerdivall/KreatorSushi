...
enum ESushi {
    ...
    PhiladelphiaSalmonMaki("Philadelphia Salmon Maki", ESkladnik.Salmon, ESkladnik.Avocado, ESkladnik.Rice, ESkladnik.Nori),
    VegeFutomaki("Vege Futomaki", ESkladnik.Kappa, ESkladnik.Rice, ESkladnik.Avocado, ESkladnik.Oshinko, ESkladnik.Nori, ESkladnik.Kanpyo);
...
public class Main extends JPanel {
    ...
    private void stworzKlawiszCheck() throws IOException {
        ...
        klawisz.addMouseListener(new MouseAdapter() {
            ...
            private void czyKoniecGry() {
                if (zycia < 1) {
                    JOptionPane.showMessageDialog(null, "Twój wynik: " + punkty);
                    zycia = 5;
                    losuj();
                    punkty = 0;
                    repaint();
    ...
    private void stworzPanelKlawiszy() throws IOException {   // < ========
        ...
        File[] grafiki = new File("Skladniki/").listFiles();
